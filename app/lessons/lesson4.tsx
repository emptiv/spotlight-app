...
const LESSON_ID = "kd708pwrbfnwp35n5h1w7aygs57qdvfq";
...
const characters = [
  {
    ...
    guideImage: require("@/assets/guides/img/sa.png"),
    gifDuration: 4300,
  },
  {
    symbol: "ᜇ",
    ...
    guideImage: require("@/assets/guides/img/dara.png"),
    gifDuration: 4740,
  },
  {
    symbol: "ᜆ",
    ...
    guideImage: require("@/assets/guides/img/ta.png"),
    gifDuration: 4200,
  },
].map((char) => ({
  ...char,
